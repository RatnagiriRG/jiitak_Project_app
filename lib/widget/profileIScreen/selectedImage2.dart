...
class SelecetedImage2 extends StatefulWidget {
  const SelecetedImage2({super.key});

  @override
  State<SelecetedImage2> createState() => _SelecetedImage2State();
}

class _SelecetedImage2State extends State<SelecetedImage2> {
